    ...
    <div class="col-lg-6">
      <div class="card">
        <div class="card-title">
          <h4>Ajouter un parc</h4>
        </div>
        <div class="card-body">
          <div class="basic-form">
            <form>
              <div class="form-group">
                <p class="text-muted m-b-15 f-s-12">gloubiloubalouba </p>
                <input type="text" class="form-control input-default " placeholder="Renseignez le nom du restaurant">
              </div>
              <div class="form-group">
                <p class="text-muted m-b-15 f-s-12">gloubiloubalouba tabadawaba </p>
                <input type="text" class="form-control input-default" placeholder="Renseigner l'adresse du restaurant">
              </div>
              <div class="form-group">
                <p class="text-muted m-b-15 f-s-12">gloubiloubalouba tabadawaba toutifoufifé </p>
      ...
      <div class="card">
        <div class="card-body p-b-0">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="#rivedroite" role="tabpanel">
              <div class="p-20">
                <h5><?php echo $park['name'] ?></h5>
                <h6><?php echo $content['adress'] ?></h6>
